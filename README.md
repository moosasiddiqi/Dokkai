...
![PageMind Demo](demo.gif)

---

## What it does

PageMind is a Chrome extension that opens as a sidebar on any webpage. In one click it reads the page, generates an AI summary, and lets you ask follow-up questions — all without leaving the tab.
...
4. Click **Load unpacked** and select the `pagemind-extension` folder

5. Click the PageMind icon in your toolbar to open the sidebar
